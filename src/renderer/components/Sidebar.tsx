  ...
  return (
    <aside className="flex w-full flex-col border-r border-slate-200 bg-slate-900 text-white lg:w-72">
      <div className="border-b border-slate-800 px-6 py-8">
        <p className="text-xs uppercase tracking-[0.3em] text-slate-400">Odontologia</p>
        <h1 className="mt-3 text-2xl font-semibold">Dentis Soft</h1>
        <p className="mt-2 text-sm text-slate-400">Plataforma para la gestion de pacientes y fichas clinicas.</p>
      </div>
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              `block w-full rounded-2xl px-4 py-4 text-left transition ${
                isActive ? "bg-teal-600 text-white shadow-lg shadow-teal-950/30" : "bg-slate-800/60 text-slate-200 hover:bg-slate-800"
              }`
            }
          >
